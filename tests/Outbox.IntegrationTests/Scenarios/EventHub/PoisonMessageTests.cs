...
public class PoisonMessageTests
{
    ...
    public async Task PoisonMessage_EventuallyDeadLettered_DoesNotBlockOtherMessages()
    {
        ...
        try
        {
            ...
            await InsertPoisonMessageAsync(_infra.ConnectionString, eventHub, poisonKey);
            await OutboxTestHelper.InsertMessagesAsync(_infra.ConnectionString, 5, eventHub, healthyKey);
